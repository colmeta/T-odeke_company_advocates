            ...
            <div className="container px-4 md:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3 text-sm text-gray-400">
                            <li><Link href="/practice-areas" className="hover:text-secondary transition-colors">Corporate Law</Link></li>
                            <li><Link href="/practice-areas" className="hover:text-secondary transition-colors">Criminal Defense</Link></li>
                            <li><Link href="/practice-areas" className="hover:text-secondary transition-colors">Family Law</Link></li>
                            <li><Link href="/practice-areas" className="hover:text-secondary transition-colors">Real Estate & Property</Link></li>
                            <li><Link href="/practice-areas" className="hover:text-secondary transition-colors">Civil Litigation</Link></li>
                        </ul>
                    </div>
